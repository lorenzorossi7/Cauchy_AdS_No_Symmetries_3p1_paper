...
set output 'phi1_L2_snapshots_2.eps'
...
error2 = system("sed '5q;d' ascii_errestimate_phi1_z0_L2_usedtimesteps.txt | awk '{print $2}'")
stats 'ascii_L2uniform_phi1_z0_L2_tstep5.txt' u (abs($3)) nooutput
STATSMAXABSVAL2=STATS_max
stats 'ascii_L2uniform_phi1_z0_L2_tstep5.txt' u 3 nooutput
STATSMIN2=STATS_min
STATSMAX2=STATS_max
...
if (STATSMAXABSVAL2>error2) {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep5.txt' using 2:1:($3 !=0?$3:NaN) with pm3d title ''
} else {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep5.txt' using 2:1:($3!=0?0:NaN) with pm3d title ''
}
unset ylabel
unset colorbox
unset cbrange
...
error3 = system("sed '6q;d' ascii_errestimate_phi1_z0_L2_usedtimesteps.txt | awk '{print $2}'")
stats 'ascii_L2uniform_phi1_z0_L2_tstep6.txt' u (abs($3)) nooutput
STATSMAXABSVAL3=STATS_max
stats 'ascii_L2uniform_phi1_z0_L2_tstep6.txt' u 3 nooutput
STATSMIN3=STATS_min
STATSMAX3=STATS_max
...
if (STATSMAXABSVAL3>error3) {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep6.txt' using 2:1:($3 !=0?$3:NaN) with pm3d title ''
} else {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep6.txt' using 2:1:($3!=0?0:NaN) with pm3d title ''
}
unset colorbox
unset cbrange
unset label 3
...
error4 = system("sed '7q;d' ascii_errestimate_phi1_z0_L2_usedtimesteps.txt | awk '{print $2}'")
stats 'ascii_L2uniform_phi1_z0_L2_tstep7.txt' u (abs($3)) nooutput
STATSMAXABSVAL4=STATS_max
stats 'ascii_L2uniform_phi1_z0_L2_tstep7.txt' u 3 nooutput
STATSMIN4=STATS_min
STATSMAX4=STATS_max
...
if (STATSMAXABSVAL4>error4) {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep7.txt' using 2:1:($3 !=0?$3:NaN) with pm3d title ''
} else {
 splot 'rectgrid_ascii_L2uniform_phi1_z0_L2_tstep7.txt' using 2:1:($3!=0?0:NaN) with pm3d title ''
}
unset colorbox
unset cbrange
